...
public function __construct($idEmpresa,$nombreEmpresa,$imagen,$descripcion,$icono,$productos){
...
public static function obtenerEmpresas($idEmpresa){
    $contenidoArchivoEmpresas = file_get_contents('../data/medicamentos.json');
...
public static function obtenerEmpresa(){
    return json_decode(file_get_contents('../data/medicamentos.json'),true);
}
